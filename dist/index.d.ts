// Type definitions for definition-header v0.0.1
...
declare module 'definition-header' {
    ...
    export import schema = require('__definition-header/schema');
...
declare module '__definition-header/schema' {
    import Joi = require('__definition-header/index/__/joi');
    export var semver: Joi.StringSchema;
    export var uri: Joi.StringSchema;
    export var label: Joi.ObjectSchema;
    export var project: Joi.ObjectSchema;
    export var person: Joi.ObjectSchema;
    export var repository: Joi.ObjectSchema;
    export var header: Joi.ObjectSchema;
}
...
declare module '__definition-header/index/__/joi' {
